...
const PropertyCard = ({ property }) => {
  const getRateDisplay = () => {
    ...
    if (rates.monthly) {
      return `$${rates.monthly.toLocaleString(rates.monthly)}/mo`;
    } else if (rates.weekly) {
      return `$${rates.weekly.toLocaleString(rates.weekly)}/wk`;
    } else if (rates.nightly) {
      return `$${rates.nightly.toLocaleString(rates.nightly)}/night`;
    }
  };
  return (
